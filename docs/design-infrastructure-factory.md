...
explicitly a waypoint ("I never planned for this to stay in this repo").
*Recommendation: the contract lives here in `environments/`; the factory
itself graduates to a `the-metafactory` repo when Vincent is ready, with his
history preserved; his repo remains his.*
